<template>
    ...
    <ShareFolderModal v-model="showEmailsModal" :all-selected="allSelected" :selected-ids="selectedIds">
...
import ShareFolderModal from "@/Components/app/ShareFolderModal.vue";

 export default {
     components: {ShareFolderModal, ConfirmationDialog},
